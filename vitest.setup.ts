...
// Postgres instance (a real server binary via `embedded-postgres`, booted
// and torn down once per run by `vitest.global-setup.ts`) — not the same
// physical store as DATABASE_URL. Isolation between individual tests still
